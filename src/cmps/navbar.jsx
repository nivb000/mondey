...
export const NavBar = () => {
    ...
    return <nav className='new-navbar'>
        <div className='flex space-between align-center navbar-main'>
            <div className='flex align-center left-side'>
            ...
            <div className='flex space-between right-side'>
                ...
                <Link to="/login"><MdLogout onClick={handleLogOut} /></Link>
            </div>
        </div>
    </nav>
}
